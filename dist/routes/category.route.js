...
router.get('/:id', [
    ...
    (0, express_validator_1.check)('id').custom(dbValidatorHelper_1.existCategoryById),
    (0, express_validator_1.check)('id').custom(dbValidatorHelper_1.existCategoryByStatus),
